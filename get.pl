...
my $db = tie (my %webmercator, 'DB_File', 'webmercator.db', O_RDWR | O_CREAT, 0644, $DB_HASH);
...
my $imgA = sprintf ('Full_%5.5d_%5.5d_%5.5d_%5.5d_%5.5d.png', $lev, $rowA, $colA, $rowB, $colB);
