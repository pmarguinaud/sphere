...
static 
void glgauss (const int Nj, const int pl[], unsigned int * ind, const int nstripe, int indcnt[])
{
  int iglooff[Nj];
...
void getNeighbours (const jlonlat_t & jlonlat, const geom_t & geom, neigh_t * neigh)
{
